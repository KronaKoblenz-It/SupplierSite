...
// **********************************************************************
   ...
   function makeHttpXml() {
	...
	function sommaColli() {
	var cf = document.lettura;
	cf.TOTALE.value =  parseInt(cf.scatole.value) + parseInt(cf.fasci.value) + parseInt(cf.bancali.value) + parseInt(cf.cassoni.value) + parseInt(cf.rotoli.value);
	}
