...
//  $code     = '123456789012'; // barcode, of course ;)
  ...
  for($ex=0; $ex<2; $ex++) {
    $x0 = $ex*4*72;
	$x = $x0 + 2.3*72;	 // barcode center
    for($ey=0; $ey<8; $ey++) {
	  $y0 = $ey*360/254*72;
	  $y = $y0 + 60;	// barcode center
	  
	  // altri testi
	  $pdf->SetFont('Arial','B','14');
	  $pdf->Text($x0+20, $y0+30, $cCodice);
	  $pdf->SetFont('Arial','','11');
	  $pdf->Text($x0+20, $y0+42, $cDesc);
//	  $pdf->SetXY($x0+20, $y0+38);
//	  $pdf->MultiCell(180,14, $cDesc, 0, 'L');
...
//	  $pdf->Image("$dbase.jpg", $x0+20, $y0+75, 30 );
	  ...
	  $pdf->Text($x0+20, $y0+80, "Lotto: $cLotto");
	  $data = Barcode::fpdf($pdf, $black, $x0+110, $y0+95, $angle, 'code39', array('code'=>$cLotto), $width, 16);
