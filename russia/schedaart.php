...
print("<th class=\"list\">Rettifica</th>\n");
...
while($row = db_fetch_row($queryexe)) { 
	...
	print ("<td class=\"list\" style=\"text-align: right;\">" . ($row[1] > 0 ? $row[0] : "&nbsp;") . "</td>\n");
	print ("<td class=\"list\" style=\"text-align: right;\">" . ($row[2] > 0 ? $row[0] : "&nbsp;") . "</td>\n");
    print ("<td class=\"list\" style=\"text-align: right;\">" . ($row[3] > 0 ? $row[0] : $row[3] < 0 ? -$row[0] : "&nbsp;") . "</td>\n");
	print ("<td class=\"list\" style=\"text-align: right;\">$progr</td>\n"); 
