...
print("<tr class=\"list\">\n");
if("F01021" == $cookie[0]) {
	print("<th class=\"menu\"><a href=\"cli-detail.php?id=" . $cookie[0] . "\">" . _("Carichi di produzione & Ordini Lav. Interni") ."</a></th>\n");
} else {
	print("<th class=\"menu\"><a href=\"cli-detail.php?id=" . $cookie[0] . '">'.$str_eleord[$lang]."</a></th>\n");
}
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"art-detail.php?id=" . $cookie[0] . "\">" . _("Articoli in ordine") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"askdb.php\">" . _("Inserimento bolla") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"ddttoload.php\">" . _("Bolle in attesa di acquisizione") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"ddtimport.php\">" . _("Caricamento bolle da file XML") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"ddtimportxls.php\">" . _("Caricamento bolle da file Excel") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"giornalemaga.php\">" . _("Situazione magazzino") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"bollecons.php?id=" . $cookie[0] . "\">" . _("DDT Materiale da lavorare") ."</a></th>\n");
print("</tr>\n");
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"artcons.php?id=" . $cookie[0] . "\">" . _("Rettifica articoli consegnati") ."</a></th>\n");
print("</tr>\n");

print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"rnc.php\">" . _("Rapporti di non conformit&agrave;") ."</a></th>\n");
print("</tr>\n");
...
if( !($row = db_fetch_row($queryexe)) ) {
	print("<th class=\"menu\"><a href=\"inventario.php\">" . _("Inserimento inventario") ."</a></th>\n");
} else {
...
print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"inv-list.php\">" . _("Verifica inventario") ."</a></th>\n");
print("</tr>\n");

print("<tr class=\"list\">\n");
print("<th class=\"menu\"><a href=\"manualistica.php\">" . _("Manualistica") ."</a></th>\n");
print("</tr>\n");
print("</table>\n");
