...
$Query = "SELECT MAGART.CODICE, MAGART.DESCRIZION, MAGART.U_ARTCOLLO, MAGART.U_DESCOLLO as DESCOLLOEXTRA, MAGART.U_NCOLLI, COLLO.CODICE as CODCOLLO, COLLO.DESCRIZION as  DESCOLLO";
