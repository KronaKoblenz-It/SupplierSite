			...
			if($lastbolla != ($bollaNum . $artP . $lottoP . $tipoRifOrd . $numRifOrd . $rifRiga)) {
				if($isInizio){
					...
					if($ERR_DIST){
						...
						print("<div style=\"text-align: center;\"><span id=\"ErrDist$k\"><b>Controlla Distinta con Riferimento alla Data del Documento (<a href=\"http://intranet.krona.it/krona/art-distbase.php?id=". $rifFromT ."\" target=”_blank” title=”Distinta Base”>clicca qui</a>)</b></span></div> </br>\n");
