...
//query database 
	...
	print("<td class=\"list\" align=\"center\"><a href=\"okdoc.php?id=" . $row[1] . "\" ><img noborder src=\"../img/b_check.png\" height=\"18px\"></a></td>\n");
        print("<td class=\"list\" align=\"center\"><a href=\"deldoc.php?id=" . $row[1] . "\" ><img noborder src=\"../img/b_drop.png\"></a></td>\n");
        print("</tr>\n");
    } 
