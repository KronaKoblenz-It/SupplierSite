    ...
    /*	if( $isOF or $isBollaCL ) {
	  ...
	  if( $isOF ) {
		...
		if($isWurth){
			...
			if($row->U_CLIVEN == "C05332") {
				...
				print_label("etich.php", "Etichetta 88x36", $art, $row->LOTTO, $row->DESCRIZION, $barcodeCF, $row->U_CLIVEN, $row->U_DESTCLI);
				print_label("etich.php", "Etichetta 88x36 - Scatole", $art, $row->LOTTO, $row->DESCRIZION, $barcodeSC, $row->U_CLIVEN, $row->U_DESTCLI, "", "SC");
				print_label("etich.php", "Etichetta 88x36 - Pezzi", $art, $row->LOTTO, $row->DESCRIZION, $barcodePZ, $row->U_CLIVEN, $row->U_DESTCLI, "", "PZ");					
			}
		}
		if($isIndia) {
	  ...
	  if( $isBollaCL ) {
		  if($row->U_CLIVEN == "C05332") {
			  ...
			  print_label("etich.php", "Etichetta 88x36", $art, $row->LOTTO, $row->DESCRIZION, $barcodeCF, $row->U_CLIVEN);
			  print_label("etich.php", "Etichetta 88x36 - Scatole", $art, $row->LOTTO, $row->DESCRIZION, $barcodeSC, $row->U_CLIVEN, "", "", "SC");
			  print_label("etich.php", "Etichetta 88x36 - Pezzi", $art, $row->LOTTO, $row->DESCRIZION, $barcodePZ, $row->U_CLIVEN, "", "", "PZ");
		  }
