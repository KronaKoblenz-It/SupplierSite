...
// riga del padre
$id = scriviRiga($id, $id_testa, $id_rigapadre, 'P', $fornitore, $_POST['padre'], $_POST['quantita'], $_POST['lottopadre'], $maga, '', $cliven, $_POST['rifr'], 'CT');

// righe componenti
for ($j = 1; $j <= $count; ++$j) {
    $id = scriviRiga($id, $id_testa, $id_rigapadre, 'C', $fornitore, $_POST["code$j"], $_POST["qta$j"], $_POST["lotto$j"], $maga, '', 'C', $_POST["rifr$j"], 'CT');
}
...
// ------------------------------------------
// Funzioni
function scriviRiga($id, $id_testa, $id_rifriga, $espldistin, $fornitore, $codicearti, $qta, $lotto, $maga, $descrizion, $cliven, $rifr, $tipodoc)
{
    global $conn, $nDocF;
