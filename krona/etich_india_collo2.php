...
$Query = "SELECT DESCRIZION, NOTE, QTACONF, UNMISURA, U_ARTCOLLO FROM MAGART WHERE CODICE = \"$cCodice\"";
...
if($numpack != 0){
  ...
  // }
  $pdf->Text(55, 145, $cArtCollo);
  $cComposed = "Composed by " . ($cCodiceAlt == "" ? $cCodiceR : $cCodiceAlt) . " and $cArtCollo";
  $pdf->SetFont('Arial','B','7');
  $pdf->Text(10, 153, $cComposed);
