...
//query database 
    ...
    print ("<td class=\"list\" align=\"right\">" . number(xRound($row[3])) . " KG </td>\n"); 
...
print("<tfoot>\n");
print("<tr class=\"list\">\n");
print("<td class=\"list\" colspan=\"6\" align=\"right\" valign=\"center\"><a href=\"schedaartx.php?maga=$maga&esercizio=$eserc\" >"); 
