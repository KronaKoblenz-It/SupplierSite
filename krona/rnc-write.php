...
mail("spedizioni@koblenz.it;ricevimento.merci@k-group.com;ced@k-group.com;ced-it@k-group.com",
      "Generata RNC per sfridi da $fornitore",
      "Il fornitore $fornitore ha creato una RNC di sfrido per l'articolo ".$row->CODICEARTI." contenuto nel doc.".$_POST["tipodoc"]." ".$_POST["numerodoc"],
