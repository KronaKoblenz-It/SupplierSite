...
$Query .= "MAGART.DESCRIZION, MAGART.PESOUNIT, MAGART.UNMISURA ";
...
//query database 
    ...
    print ("<td class=\"list\" align=\"right\">" . number(xRound($row[1]-$row[3])) . "</td>\n");
...
print("<tfoot>\n");
print("<tr class=\"list\">\n");
print("<td class=\"list\" colspan=\"9\" align=\"right\" valign=\"center\"><a href=\"schedaartx.php?maga=$maga&esercizio=$eserc\" >"); 
