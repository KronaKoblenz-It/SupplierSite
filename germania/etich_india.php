...
$numpack = 0;
$Query = "SELECT QTACONF, U_CE, UNMISURA1, FATT1, UNMISURA2, FATT2, UNMISURA3, FATT3 FROM MAGART WHERE CODICE = '" . $cCodice . "'";
$queryexe = db_query($conn, $Query) or die(mysql_error());
$row = mysql_fetch_object($queryexe);
if("CF" == $row->UNMISURA1) {
	$numpack = $row->FATT1;
...
$pdf->SetFont('Arial','B','9');
$pdf->Text(55, 145, $cCodice);

$pdf->SetFont('Arial','B','6');
$pdf->Text(160, 145, "Quantity:");
$pdf->SetFont('Arial','B','9');
$pdf->Text(200, 145, $nQtaconf . " " . $cUM);
