...
banner(_("Scheda di magazzino"),"$art - " . $row[0]);
$isLotti = $row[1];
if($isLotti){
	//
	...
	print("</br><div style=\"text-align: center;\"><span id=\"Title1\"><b>" . _("Situazione Giacenza Lotti") . "</b></span></div><div> </br>\n");	
		...
		print("<tr >\n");
		print("<th >" . _("Lotto") . "</th>\n"); 
		print("<th >" . _("Prog. Carico") . "</th>\n"); 
		print("<th >" . _("Prog. Scarico") . "</th>\n"); 
		print("<th >" . _("Prog. Rettifica") . "</th>\n");
		print("<th >" . _("Giacenza") . "</th>\n");
		print("</tr>\n");
...
print("<tr>\n");
print("<th>" . _("Data") . "</th>\n"); 
print("<th>" . _("Riferimento") . "</th>\n"); 
print("<th>" . _("Carico") . "</th>\n"); 
print("<th>" . _("Scarico") . "</th>\n");
print("<th>" . _("Rettifica") . "</th>\n");
print("<th>" . _("Progressivo") . "</th>\n"); 
print("<th>" . _("Lotto") . "</th>\n"); 
print("</tr>\n");
...
print ("<td  style=\"text-align: right;\">&nbsp;</td>\n");
print ("<td style=\"text-align: right;\">$progrV</td>\n"); 
print ("<td>&nbsp;</td>\n"); 
print ("</tr>\n"); 
